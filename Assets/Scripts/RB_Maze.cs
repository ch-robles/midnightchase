...
public class RB_Maze : MonoBehaviour
{
	...
	private float wallLength = 5f; //2.5 previous
	// IMPORTANT PART!!! ADJUSTS THE WALL LENGTH OF THE thingy
	private Wall wallTrait;
	...
	public void CreateWall()
	{
		...
		startPosition = new Vector3(3, 0, 5.5f);
